...
def _train_one_experiment_inner(
    ...
    for epoch in range(start_epoch, args.epochs + 1):
        ...
        if epoch % args.eval_every == 0 or epoch == args.epochs:
            ...
            log.info(
                ...
                f" ade={r_tgt.ade_km:.1f}km fde={r_tgt.fde_km:.1f}km"
            ...
            history.append({
                ...
                "source ade km":                          r_src.ade_km,
                "source fde km":                          r_src.fde_km,
                # Target
                ...
                "target ade km":                          r_tgt.ade_km,
                "target fde km":                          r_tgt.fde_km,
                **epoch_metrics,
            })
    ...
    result = {
        ...
        # ── Track forecasting ────────────────────────────────────────────────
        "final source ade km":                          final_src.ade_km,
        "final source fde km":                          final_src.fde_km,
        "final target ade km":                          final.ade_km,
        "final target fde km":                          final.fde_km,
        "final target ade per step":                    final.ade_per_step,
        "final target n track samples":                 final.n_track_samples,
        # ── Metadata ────────────────────────────────────────────────────────
        "history":   history,
        "best_ckpt": best_ckpt,
    }
